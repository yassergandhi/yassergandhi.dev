...
Rutas: `/`, `/evaluacion` (`noindex, follow`), `/contacto` (redirect permanente) y `/version.json`. Se conservan Tally `MeQjR0`, seis hidden fields, las URL impresas CANACO y Vercel Web Analytics.
